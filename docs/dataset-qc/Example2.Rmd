...
We can plot the same slice at different times (frames), and calculate statistics from individual frames or across time. The frames look quite similar, but there are small differences, as reflected in the maximum voxel value printed on each image.
```{r}
options(repr.plot.width=8, repr.plot.height=3);  # specify size in jupyter
...
text(x=0.2, y=0.95, labels="frame 1", col='lightblue');  # add a label
