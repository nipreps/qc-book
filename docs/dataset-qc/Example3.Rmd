...
plot.means <- function(rid, pid, show.legend=FALSE) {   # rid <- 1; pid <- 116;  
  ...
  if (show.legend == TRUE) { legend('top', col=sub.clrs, lwd=2, legend=sub.ids, bty='n', ncol=2); }
...
```
Now we call this new function to plot the timecourses for the same motor parcel (116):
