...
We can use parcel 116 as a motor control: ![parcel 116](example3/Schaefer1000x17_p116_outer.jpg)
...
in.path <- "example3/";    # directory with the input files, usually something like in.path <- "d:/temp/input/";   
